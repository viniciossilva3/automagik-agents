...
[System prompt(s)](https://ai.pydantic.dev#system-prompts)

[Function tool(s)](https://ai.pydantic.dev/tools/)

[Structured result type](https://ai.pydantic.dev/results/)

[Dependency type constraint](https://ai.pydantic.dev/dependencies/)

[LLM model](https://ai.pydantic.dev/api/models/base/)

[Model Settings](https://ai.pydantic.dev#additional-configuration)
...
run_agent.pyfrom pydantic_ai import Agent
